...
public class Screen_LOAD_PROCESS extends Screen{
	//public PNG_STRUCT pngStruct0[]=new PNG_STRUCT[16];
	//public TXT_STRUCT txtStruct[]=new TXT_STRUCT[0];
//pngLoc=-1;
//txtLoc=-1;
private void initPng(){
	PNG_STRUCT pngs[]=new PNG_STRUCT[16];
	...
	pngs[13].setValues(null,"pub\\返回并退出.png",711,1,1,-1,0);
	pngs[14].setValues("取消","pub\\返回并退出1.png",711,0,0,-1,0);
	pngs[15].setValues("光盘","加载条\\光盘.png",48,11,7,-1,0);
	setPngs(pngs);}
