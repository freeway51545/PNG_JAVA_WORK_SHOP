...
public class Screen_DVP_DVD2 extends Screen{
...
private void initPng(){
	...
	pngs[0].setValues(null,"DVP_DVD2\\DVD-2-1.png",0,0,1,-1,0);
	pngs[1].setValues(null,"DVP_DVD2\\DVD-2-2.png",0,0,8,-1,0);
	...
	pngs[14].setValues("喇叭","播放控制图标\\喇叭.png",598,11,1,-1,0);
	pngs[15].setValues("随机图标","播放控制图标\\Random.png",545,10,7,-1,0);
	pngs[16].setValues("随机关图标","播放控制图标\\Random_disable.png",545,10,7,-1,0);
	pngs[17].setValues("重复关图标","播放控制图标\\Repeat_off.png",472,11,7,-1,0);
	pngs[18].setValues("单曲重复图标","播放控制图标\\Repeat_One.png",471,11,7,-1,0);
	pngs[19].setValues("重复所有图标","播放控制图标\\Repeat_All.png",472,10,7,-1,0);
	pngs[20].setValues("文件数图标","播放控制图标\\文件数.png",59,13,1,-1,0);
