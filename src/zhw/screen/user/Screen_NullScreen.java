...
private void initPng(){
	...
	pngs[2].setValues("返回","关屏与返回\\主页1.png",0,-1,0,-1,0);
	pngs[3].setValues(null,"pub\\返回并退出.png",745,0,1,-1,0);
	pngs[4].setValues("关闭","pub\\返回并退出1.png",745,0,0,-1,0);
	pngs[5].setValues(null,"AU_X\\亮度.PNG",683,0,1,-1,0);
	pngs[6].setValues("屏幕调节","AU_X\\亮度1.PNG",683,0,0,-1,0);
	setPngs(pngs);}
